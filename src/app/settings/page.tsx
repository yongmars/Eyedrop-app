              ...
              <div className="space-y-4">
                {activeMedicines.map((med) => (
                  ...
                  >
                    ...
                    <div className="border-t border-gray-100 dark:border-gray-700 pt-3 grid grid-cols-2 gap-2">
                      <button
                        type="button"
                      ...
                      <button
                        ...
                        className="col-span-2 bg-red-50 hover:bg-red-100 text-red-600 dark:bg-red-955/20 dark:text-red-400 dark:hover:bg-red-900/30 font-bold text-xs px-4 py-2.5 rounded-xl border border-red-200 dark:border-red-900/30 transition-all flex items-center justify-center gap-1.5 cursor-pointer touch-manipulation min-h-[38px]"
                      >
